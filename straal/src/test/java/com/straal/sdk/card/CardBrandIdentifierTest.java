...
class CardBrandIdentifierTest {
    ...
    static Stream<Arguments> validCardNumbers() {
        return Stream.of(
                ...
                Arguments.of("3530111333300000", CardBrand.JBC),
                Arguments.of("3566002020360505", CardBrand.JBC),
                Arguments.of("3539865630059491", CardBrand.JBC),
                Arguments.of("3548938244607770", CardBrand.JBC),
                Arguments.of("3548004503181732", CardBrand.JBC),
                Arguments.of("3578272254540348", CardBrand.JBC),
